...
const getTastyProgram = (data,callback,errorCallback) => {
    http.get('/recommend/tasty', header())
    .then(res => {
        if(res == null) {
...
const RecommendApi = {
    getTastyProgram:(data,callback, errorCallback)=>getTastyProgram(data, callback, errorCallback)
