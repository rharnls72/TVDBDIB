<template>
    <b-nav justified class="myfooter pt-1">
      ...
      <b-nav-item @click="changeState(1), moveTab('FeedMain')">
        <b-icon-people-fill v-if="currentTabNo == 1" class="myactiveicon"></b-icon-people-fill>
