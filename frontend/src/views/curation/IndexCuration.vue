      ...
      setTimeout(() => {
        ...
        for (let i = this.curations.length + 1; i <= this.curations.length + 1; i++) {
          ...
          temp.push({
            ...
            genre: `${i}. 프로그램의 장르`,
            description: `${i}. 에피소드에 대한 정보입니다. 에피소드에 대한 정보입니다. 에피소드에 대한 정보입니다. 에피소드에 대한 정보입니다. 에피소드에 대한 정보입니다. 에피소드에 대한 정보입니다. 에피소드에 대한 정보입니다.`,
            broadcast_time: `${i}. 에피소드의 방송 시간`,
            thumbnail: `${i}. 에피소드의 썸네일 url`,
          })
        }
